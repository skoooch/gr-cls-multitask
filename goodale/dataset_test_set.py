...
with h5py.File(filepath, 'a') as h5file:
    ...
    for width in range(30, max_rect_size,5):
        for height in range(30, max_rect_size,10):
            ...
            for i, camera_pos in enumerate(camera_pos_list[0:1]):
                ...
                for j, shadow_vec in enumerate([(10,10), (10, -10), (-10, -10), (-10, 10)][0:1]):
                    ...
                    data[width-30, ((height-30)//2), 1,1,0,0,0] = shift_x
                    data[width-30, ((height-30)//2), 1,1,0,0,1] = shift_y
                    h5file.flush() 
